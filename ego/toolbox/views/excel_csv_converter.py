...
def excel_csv_converter_view(request):
    ...
    tool = [x for x in all_tools if x["id"] == "excel_csv_converter"][-1]
    ...
    if request.method == "GET":
        ...
        return render(request, "toolbox/pages/excel_csv_converter.html", context)
        ...
        if action == "excel_to_csv":
            ...
            try:
                ...
                try:
                    ...
                    return render(request, "toolbox/partials/excel_csv_result.html", context)
            ...
            try:
                ...
                return render(request, "toolbox/partials/csv_excel_result.html", context)
