...
def excel_merger_view(request):
    ...
    if request.method == "GET":
        return render(request, "toolbox/pages/tools/dev/excel_merger.html", build_tool_context("excel_merger"))
    ...
    if request.htmx:
        ...
        if action == "merge":
            ...
            try:
                ...
                return render(request, "toolbox/partials/excel/merger_result.html", context)
...
ROUTES = [
    ("excel-merger/", excel_merger_view, "excel_merger", "excel_merger"),
]
