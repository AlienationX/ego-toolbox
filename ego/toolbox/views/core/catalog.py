...
from toolbox.views.core.routing import get_tool_route_name_map


def _tool_url(tool_id):
    route_name = get_tool_route_name_map().get(tool_id)
    if not route_name:
        return None

    try:
        return reverse(f"toolbox:{route_name}")
...
def get_tool_catalog():
    return [
        ...
        },
        {
            ...
            "url": _tool_url("base64_converter"),
        },
        {
            "id": "qrcode_tool",
            "icon": "📱",
        ...
        },
        {
            ...
            "url": _tool_url("csv_json_converter"),
        },
        {
            ...
            "url": _tool_url("excel_csv_converter"),
        },
        {
            "id": "excel_merger",
            "icon": "📊",
